...
<?php $rs=mysqli_query($conn,"SELECT * FROM infotoko WHERE id_toko='".$_GET['id']."'"); $ambil_data=mysqli_fetch_array($rs); $namatoko=$ambil_data['nama_toko']; $no=0;$a=0;$b=0;$c=0;$d=0; if(mysqli_num_rows($rs)>0) {?>
