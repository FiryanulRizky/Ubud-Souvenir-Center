...
function pesan_stok() {
    $.getJSON("../notifikasi_web/isi_notif_stok_inner.php", function(data_stok) {
        ...
        $.each(data_stok.result_stok, function() {
            $("#pesan_stok").append(`<a id="pesan_stok" class="dropdown-item" href="../PROSES_ALGORITMA_APRIORI/daftar_item.php"><br><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
