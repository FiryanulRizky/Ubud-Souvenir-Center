...
<html>
  ...
  <body>
    ...
    <table width="40%" height="40" style="text-align: center; border-bottom: 1px solid red; font-weight: bold; font-size: 21px;"><tr><td><?php echo "ipm : ".format_currency($ipm);?></td><td><?php echo "total : ".format_currency($pendapatan_bersih);?></td></tr></table>
    </center>
    <div class="container">
