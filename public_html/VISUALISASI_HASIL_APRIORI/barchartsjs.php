...
echo'<div class="container"><form action='.$_SERVER["PHP_SELF"].' method="post"><div class="form-group"><div class="form-group"><label for="sel1">Lihat Item berdasarkan Pengurutan :</label>';
        $teratas="";
        $terbawah="";
...
<?php
    if (isset($_POST['kolom'])) {
      ...
      if ($_POST['kolom']=="persen_support") {
        ...
        $merk = mysqli_query($conn, "SELECT * FROM itemc1,item WHERE itemc1.kditem=item.kditem AND itemc1.id_toko='$idtoko' AND itemc1.id_toko=item.id_toko GROUP BY itemc1.kditem ORDER BY itemc1.support_count DESC LIMIT 5"); 
        ...
        $merk = mysqli_query($conn, "SELECT * FROM itemc1,item WHERE itemc1.kditem=item.kditem AND itemc1.id_toko='$idtoko' AND itemc1.id_toko=item.id_toko GROUP BY itemc1.kditem ORDER BY itemc1.support_count ASC LIMIT 5");
