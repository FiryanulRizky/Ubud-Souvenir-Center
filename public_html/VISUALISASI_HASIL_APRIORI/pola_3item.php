...
<?php
		if (isset($_POST['kolom'])) {
			...
			if ($_POST['kolom']=="persen_support") {
				...
				echo "<center><b>Data Diurutkan berdasarkan</b> <h3><i>Top 5 penjualan tertinggi</i></h3>";
				?>
            	<form method="post" action=""><input type="submit" name="reset" value="Hapus Filter" style="font-weight:bold;padding:10px;background:red;color:white;"></form></center><br><?php		
			}
			else if ($_POST['kolom']=="support_count") {
				...
				echo "<center><b>Data Diurutkan berdasarkan</b> <h3><i>Top 5 penjualan terendah</i></h3>";
				?>
            	<form method="post" action=""><input type="submit" name="reset" value="Hapus Filter" style="font-weight:bold;padding:10px;background:red;color:white;"></form></center><br><?php
			} else{
