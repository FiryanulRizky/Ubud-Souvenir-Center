...
?><h1 align="center">Daftar Riwayat Order (<?php $result = mysqli_query($conn,"SELECT * FROM pembeli WHERE id_toko='$idtoko' AND status='LUNAS' ORDER BY id_pembeli DESC"); echo mysqli_num_rows($result); ?>)</h1><br><?php
