...
function jumlah_stok() {
    ...
    $.getJSON("jumlah_stok.php", function(datas_stok) {
...
function pesan_order() {
    ...
    $.getJSON("isi_order.php", function(data) {
        ...
        $.each(data.result, function() {
            ...
            $("#pesan_order").append(`<a id="pesan_order" class="dropdown-item" style="background:lightblue;font-size:21px;font-weight:bold;" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
...
function pesan_stok() {
    ...
    $.getJSON("isi_stok.php", function(data_stok) {
        ...
        $.each(data_stok.result_stok, function() {
            ...
            $("#pesan_stok").append(`<a id="pesan_stok" class="dropdown-item" style="background:lightblue;font-size:21px;font-weight:bold;" href="../android/3_kelola_produk/item.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
...
<center><table><tr><td><br></td></tr>
    ...
    <tr><td><H3>
            ...
            <div class="dropdown">
                ...
                <?php ob_start();include "../android/1_login_reg/login_reg2.php";ob_end_clean(); $sql = mysqli_query($conn, "SELECT * FROM pembeli WHERE id_toko='$idtoko' AND status!='LUNAS'");
