...
<div class="bgkonten">
<br><center><form method="post"><input type="submit" name="kembali" value="KEMBALI" class="btn_submit" style="background:orange;font-weight:bold;color:black;"></form></center><hr style="border-bottom: 5px solid;">
<?php if (isset($_POST['kembali'])) {
	echo '<script>top.document.location.href = "index.php";</script>';
} ?>
<iframe src="update_toko.php" width=100% frameborder="0" scrolling="yes" onload="resizeIframe(this)"></iframe>
