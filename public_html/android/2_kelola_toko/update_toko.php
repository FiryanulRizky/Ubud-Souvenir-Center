...
<tr><td>&raquo;&nbsp;Deskripsi</td><td>:</td><td><textarea name="deskripsi" style="width:100%;" class="ckeditor" rows="7" placeholder="*Editing dengan style, sisip gambar, dll. layaknya Ms. Word, Silahkan Akses via website ubud-souvenir-center.my.id/admin">'.$row['deskripsi'].'</textarea></td></tr>
