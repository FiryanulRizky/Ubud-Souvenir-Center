...
echo"<div id='bgartikel2'>";
       ...
       echo"<li><a href='index.php?clear=y'>Back to Shop List</a></li>";
 ...
 echo"</table><br><hr><br><a href=\"index.php?clear=y\" class=\"tambah\"><span><input type='button' value='BACK TO SHOP LIST' style='background-color:orange;' class='btn4'></span></a>";
?>
