...
echo"<div id='bgartikel2'>";
       ...
       echo"<li><a href='../../index.php?clear=y'>Back to Menu</a></li>";
 ...
 echo"</table><br><hr><br><a href=\"../../index.php?clear=y\" class=\"tambah\"><span><input type='button' value='BACK TO MENU' style='background-color:orange;' class='btn4'></span></a>";
?>
