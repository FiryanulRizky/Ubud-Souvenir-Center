    ...
    <div class="container">
      ...
      <center><select name="status" class="teksbok_admin">
        ...
        <?php if (mysqli_num_rows($cek_item)>0) {
         ?>
        <option value="item">QR Item</option><?php } ?></select><br><table><tr><td><input type="submit" value="Pilih" style="width: 100%; text-align: center; background: blue; font-weight: bold;"></form></td><td>&nbsp;&nbsp;</td><td><form method="post" action="index.php"><input type="submit" value="Kembali" style="border:1px solid red; padding: 11px; background: orange; color: black; font-size:21px; width:100%;"></form></td></tr></table></center><?php } ?>
      ...
      <input type="submit" value="Generate QR <?php echo $namatoko3; ?>" name="create_toko">
  </form>
