...
?>
	...
	$strRule=mysqli_query($conn,"SELECT * FROM rule WHERE id_toko='$idtoko' AND kdrule='R2'");
		...
		<div class="container">
		<br><form method="post"><div class="form-group"><div class="form-group"><label for="sel1" style="font-size:36px;font-weight:bold;">Lihat Item berdasarkan Pengurutan :</label>';
				$teratas="";
				$terbawah="";
				$pindah="";
