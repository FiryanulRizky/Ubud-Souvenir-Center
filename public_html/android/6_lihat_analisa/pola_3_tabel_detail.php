...
?>
<div id="bgkonten">
<center><h2 class="art-postheader" style="font-size:36px;"> Aturan Asosiasi Pola 3 Item</h2></center>
<?php 
...
<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
    ...
    <div class="form-group">
       <table><tr><td><input type="submit" class="btn btn-info" value="Pilih" style="font-size:24px; font-weight:bold;"></form></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><form action="pola_3_tabel.php"><input type="submit" class="btn btn-info" value="Kembali" style="background:orange; font-size:24px; color:black; font-weigtht:bold;"></form></td></tr></table>
    </div>
</form>
</div><br>
<div class="view_data">
<table border="1" style="border:thin; width:100%; font-size:24px;">
