...
$cek1=mysqli_query($conn,"SELECT * FROM itemc2 WHERE id_toko='$idtoko'");
  ...
  <div class="row">
      <div class="panel-group">
        <div class="panel panel-default">
          <div class="panel-heading" background="blue"><center><H3>POLA TRANSAKSI 2 ITEM</H3><table><tr><td><form action="pola_2item.php"><b style="font-style: italic; color: red; font-size:24px;"><input type="submit" name="pola2item" value="LIHAT DETAIL"></b></form></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><form action="pola_2_tabel.php"><b style="font-style: italic; color: blue; font-size:24px;"><input type="submit" name="pola2tabel" value="DATA TABEL"></b></form></td></tr></table></center>
          </div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="panel-group">
        <div class="panel panel-default">
          <div class="panel-heading" background="blue"><center><H3>POLA TRANSAKSI 3 ITEM</H3><table><tr><td><form action="pola_3item.php"><b style="font-style: italic; color: red; font-size:24px;"><input type="submit" name="pola3item" value="LIHAT DETAIL"></b></form></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><form action="pola_3_tabel.php"><b style="font-style: italic; color: blue; font-size:24px;"><input type="submit" name="pola3tabel" value="DATA TABEL"></b></form></td></tr></table></center>
          </div>
