...
<table style="text-align: center;">
  ...
  ?>
    ...
    <tr>
      <td>&laquo;&nbsp;Tanggal Transaksi : &laquo;&nbsp;<br><input name="tgltransaksi" class="texbox" type="text" value="<?php echo date("Y-m-d"); ?>" maxlength="10"/><br><br>&laquo;&nbsp;Jam Order : &laquo;&nbsp;<br><input name="jam_order" type="text" id="jam_order" class="texbox" maxlength="8" value="<?php echo date("H:i:s"); ?>" /><br><br><input name="simpan" class="btn_submit" type="submit" id="simpan" value="Simpan" style="font-family:bauhaus md bt;color:#ffffff;font-size:12pt;border:1px solid #039; background-color:blue;" /><br><br><input type="hidden" name="act" value="add">
        <input type="reset" class="btn_submit" name="Submit2" value="Reset" style="font-family:bauhaus md bt;color:black;font-size:12pt;border:1px solid #039; background-color:orange;" /></td>    
    </tr>
  </table>
</form>