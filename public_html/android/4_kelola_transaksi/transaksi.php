...
<div class="view_data">
 ...
 $date2 = $_POST['date2'];
  ...
  echo"<center><br><br>Data ditampilkan dari rentang tanggal "; echo date('d-M-Y', strtotime($date1)); echo " sampai "; echo date('d-M-Y', strtotime($date2)); echo "<br><br><a href='transaksi.php?clear=y'><button style='color:white;background:red;padding:5px;'>Hapus Filter</button></a><br><br></center>";
 } else {
