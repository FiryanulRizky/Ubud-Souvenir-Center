...
$cek=mysqli_query($conn,"SELECT * FROM itemc1 WHERE id_toko = '".$_GET['idtoko']."'");
...
echo'<div class="container"><form method="post"><div class="form-group"><div class="form-group"><label for="sel1">Lihat Item berdasarkan Pengurutan :</label>';
    ...
    <div class="form-group">
        <td><input type="submit" class="btn btn-info" value="Pilih"></td></tr></table>
    </div>
  </div>
</form>
</div> 
<?php
    if (isset($_POST['kolom'])) {
      ...
      if ($_POST['kolom']=="persen_support") {
        $penjualan  = mysqli_query($conn, "SELECT support_count FROM itemc1 WHERE id_toko='".$_GET['idtoko']."' ORDER BY support_count DESC LIMIT 5");
        ...
        $penjualan  = mysqli_query($conn, "SELECT support_count FROM itemc1 WHERE id_toko='".$_GET['idtoko']."' ORDER BY support_count ASC LIMIT 5");
    ...
    $penjualan  = mysqli_query($conn, "SELECT support_count FROM itemc1 WHERE id_toko='".$_GET['idtoko']."' ORDER BY support_count DESC LIMIT 10");
    $merk       = mysqli_query($conn, "SELECT * FROM itemc1,item WHERE itemc1.kditem=item.kditem AND itemc1.id_toko=item.id_toko AND itemc1.id_toko='".$_GET['idtoko']."' GROUP BY itemc1.kditem ORDER BY itemc1.support_count DESC LIMIT 10"); }
?>
