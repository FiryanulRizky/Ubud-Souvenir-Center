...
if (!empty($_POST['username'])){
   ...
   if ($check>0){
    ...
    echo'<script>alert("Login Berhasil");window.location ="../Super_Admin/index.php";</script>';
   } else {

       echo'<script>alert("Maaf, Username dan Password Anda Salah");window.location ="../Super_Admin/index.php";</script>';
   }
  ...
  if($err>0){ // *** if submit error
        echo'<script>alert("Data Belum Valid/Masih Kosong, Silahkan Perbaiki, Terima Kasih");window.location ="../Super_Admin/index.php";</script>';
    } else { 
