...
while($Qrek_tk=mysqli_fetch_array($Qrek)){
    ...
    $kditem=$Qrek_tk['kditem'];
    $gambar_rek=$Qrek_tk['gambar_item'];
    $persen=$Qrek_tk['persen_support'];
    $support=$Qrek_tk['support_count'];
    echo"<hr><a href=\"./android/7_panel_guest/detail.php?id=".$kditem."&merk=".$merk_rek."&idtoko=".$Qrek_tk['id_toko']."\"><center><img src=\"./gambar/produk/".$gambar_rek."\" width=90 height=65 style='border-radius:50%;'><br><H3 style='color:black;'>$merk_rek</H3><b style='color:red;'>$persen % Top Sales</b><br><b style='color:blue;'>Favorite by $support Peoples</b></center></a>";}
} else {
