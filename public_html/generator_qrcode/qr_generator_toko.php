...
<body>
  ...
  if(isset($_POST['create_toko']))
  {
    ...
    if($insQr==true)
    {
      echo "<script>alert('Selamat QR Code $qrUname berhasil dibuat'); window.location='index.php?success=$qrimage';</script>";
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" enctype="multipart/form-data">
    <div class="container">
      ...
      <input type="text" name="qrUname" value="<?php echo $namatoko3; if(isset($_POST['create'])){ echo $_POST['qrUname']; } ?>" readonly>

      <label for="psw"><b>URL E-Commerce <?php echo $namatoko3; ?></b></label>
      <input type="text" name="qrContent" value="<?php echo'https://ubud-souvenir-center.my.id/android/8_panel_penjualan/index.php?idtoko='.$idtoko.''; ?>" readonly>
        
      <input type="submit" value="Generate QR Code <?php echo $namatoko3;?>" name="create_toko">
  </form>
