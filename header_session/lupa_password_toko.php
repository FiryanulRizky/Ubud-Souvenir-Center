...
if ($_POST['act']=="login") {
  ...
  if($err>0){ // *** if submit error
   ...
   if ($_POST['password_baru']==$_POST['password_baru_konfirm']){
    ...
    echo'<script>alert("Kunci akses baru Berhasil dibuat");window.location ="../index.php";</script>'; }
   } else {
...
<a href="../android/7_panel_guest/index.php"><img src="../gambar/images/logo.png"></a><br><br>
