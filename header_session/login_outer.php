...
<form method="post" action="./Super_Admin/index.php">

<input type="submit" name="Super_Admin" value="sp" style="background: white; color: white; border: 0px solid white;float: left;">

</form>

<a href="./android/7_panel_guest/index.php"><img src="./gambar/images/logo.png"></a>
