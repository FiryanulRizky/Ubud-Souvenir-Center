...
// $random="random";
// $status="visitor"; 
// $s = mysqli_query($conn,"SELECT * FROM statistik WHERE ip='$ip' AND tanggal='$tanggal' AND id_toko='$random'");
// $ambil_data_ip=mysqli_fetch_array($s);
// $ambil_ip=$ambil_data_ip['ip'];
// // Kalau belum ada, simpan data user tersebut ke database
// if(mysqli_num_rows($s) == 0 && $ambil_ip != $ip){
//   mysqli_query($conn,"INSERT INTO statistik(id_toko, ip, tanggal, online, status) VALUES('$random','$ip','$tanggal','1','$waktu','$status')");} 
//       else {
//         mysqli_query($conn,"UPDATE statistik SET online='$waktu', status='$status' WHERE ip='$ip' AND tanggal='$tanggal' AND id_toko='$random'");
//       }
...
<div id="header_content">	<!--start header conteent-->
	<ul>
	  ...
	  <li><a href="home.php?clear=y"><img src="../gambar/images/logo.png"></a></li>
	  <li> <?php
