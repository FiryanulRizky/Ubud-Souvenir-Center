...
echo "<a href='../header_session/konfirmasi_logout_sp.php' style='color:red;font-weight:bold;'>Anda Login Sebagai ".$nama_sp." (Super Admin)</a><h2><center>List Riwayat Data Toko (".$jml_toko.")</center></h2>";
