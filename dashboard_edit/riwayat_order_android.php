...
?><h1 align="center">Daftar Order Masuk (<?php $result = mysqli_query($conn,"SELECT * FROM pembeli WHERE id_toko='$idtoko' AND status='LUNAS' ORDER BY id_pembeli DESC"); echo mysqli_num_rows($result); ?>)</h1><br><?php


$result = mysqli_query($conn,"SELECT * FROM pembeli WHERE id_toko='$idtoko' AND status='LUNAS' ORDER BY id_pembeli DESC");
...

       {
         ...
         <tr style='width:100%;'>
          ...
          <tr style='width:100%;'>
            ...
            <td colspan='3'><center><a href=\"".$_SERVER['PHP_SELF']."?id=".$row['kode_order']."&amp;act=delete\">
            <input type='button' value='Hapus' class='btn_submit'></a></center></td>
