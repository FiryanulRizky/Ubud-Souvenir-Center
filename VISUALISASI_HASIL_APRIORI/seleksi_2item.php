...
<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
	<div class="form-group">
        ...
        ?>
            <select class="form-control" name="kolom" required>
                ...
                <option value="support" <?php echo $support; ?> >Persentase</option>
         </select>
     </div>
        ...
        ?>
        <input type="text" name="kata_kunci" placeholder="Masukkan hanya data angka" maxlength="4" class="form-control"  required/>
    </div>
    <table>
   	<tr>
    ...
    <td><div class="form-group">
        ...
        <input type="submit" name="reset" class="btn btn-info" value="Kembali" style="background:orange;"></form></div></td>
    </tr>
    </table>
</div>
<?php
if (isset($_POST['kata_kunci'])) {
            ...
            <form method="POST" action="seleksi_2item.php"><button type="submit" name="reset" >Hapus Filter</button></form>
            <?php
            }
        }else {
