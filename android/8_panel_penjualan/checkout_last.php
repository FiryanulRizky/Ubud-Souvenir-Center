...
if ($_POST['act']=="order"){
    ...
    if($err>0){ // *** if submit error
        ...
        ."VALUES ('".$_POST['kode_order']."','".$_GET['idtoko']."','".$baris."','".date("Y-m-d")."','".date("h:i:s")."')");
...
while($harga1=mysqli_fetch_array($query_harga)) {
  ...
  $idtoko=$_GET['idtoko'];
    ...
    @mysqli_query($conn,"UPDATE pendapatan SET April=April + ($harga*$quantity) WHERE id_toko='$idtoko' AND kditem='$product_id'");
        ...
        mysqli_query($conn,"INSERT INTO pembeli(kode_order,id_toko,nama_pembeli,email_pembeli,testi_singkat,tanggal,jam_order,info_belanja,status) "."VALUES ('".$_POST['kode_order']."','".$_POST['id_toko']."','".$_POST['namalengkap']."','".$_POST['email']."','".$_POST['testi']."','".$_POST['tanggal']."','".$_POST['jam_order']."','".$_POST['info_belanja']."','".$_POST['status']."')");
...
sendNotif($to, $notification);
  ...
  // @mysqli_query($sql_edit);
        ...
        Please visit '.$namatoko.' commerce site here ubud-souvenir-center.my.id/android/8_panel_penjualan/index.php?idtoko=2
        also our official site ubud-souvenir-center.my.id/android/7_panel_guest/home.php
...
echo'
    ...
    <tr><td>&raquo; Date &nbsp;&nbsp; </td><td class="cv"><input name="tanggal" size="40" class="texbox" value= '.date('d-F-Y').'  readonly></td></tr>
    ...
    <tr><td>&raquo; Your Email*  </td><td class="cv"><input name="email" class="texbox" size="40" maxlength="30" value="'.$_POST['email'].'"><br>'.$err['email'].'</td></tr>
