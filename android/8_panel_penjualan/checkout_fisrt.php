...
if($_SESSION['cart']) {
    ...
    $checkout_cnt.= "<tr>
       ...
       // LOOPING / PENGULANGAN : UNTUK MENDEFINISIKAN ISI KERANJANG
        ...
        $checkout_cnt.=""."<a href=\"$_SERVER[PHP_SELF]?action=empty&idtoko=".$_GET['idtoko']."\" class=\"btnkrnjg\" onclick=\"return confirm('Sure you want to delete?');\"><input type='button' value='Delete All' class='btn3'></a>";
