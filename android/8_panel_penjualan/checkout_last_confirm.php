...
<div class="modal-content animate" method="post" enctype="multipart/form-data">
    <div class="container">
      ...
      <form method="post"><input type="submit" name="e-payment" value="E-PAYMENT / E-BANKING" style="font-size:48px;width:100%;background:lightgreen;font-weight:bold;"><br><input type="submit" name="cancel" value="CANCEL" style="font-size:48px;width:100%;background:red;font-weight:bold;"></form>
      </div>
