...
<html>
  ...
  <body style="background:#DFE6F0;">
    <center><a href="linechart_jumlah_jual.php"><H3>RIWAYAT PENDAPATAN</H3></a></center>
    <?php ob_start(); include"tangkap_data_cpm.php"; ob_end_clean(); ?>
    <center></center><table width="100%" height="40" style="text-align: center; border-bottom: 1px solid red; font-weight: bold; font-size: 14px;"><tr><td><?php echo "cpm : ".format_currency($cpm);?></td><td><?php echo "total : ".format_currency($pendapatan_bersih);?></td></tr></table>
    </center>
    <div class="container">
