...
if (!empty($date1&&$date2)) { 
    echo"<center><h2 class='art-postheader'>Aturan Asosiasi Pola 2 Item dengan seleksi</h2></center>"; } else {
        echo"<center><h2 class='art-postheader'> Aturan Asosiasi Pola 2 Item</h2></center>";
    }
?>
<?php
...
<?php 
if (!empty($date1&&$date2)) { 
    echo"<b>Data diseleksi berdasarkan tanggal $date1 sampai $date2</b><br>"; }
?>
...
<tr style="background-color: lightgrey;text-align: center;">
  ...
  if (!empty($date1&&$date2)) {
  $transaksi=mysqli_query($conn,"SELECT * FROM transaksi WHERE id_toko='$idtoko' AND tgltransaksi BETWEEN '$date1' AND '$date2' GROUP BY kdtransaksi");    
  } else {
...
<tr style="background-color: lightgrey;text-align: center;">
		...
		<tr style="text-align: center;">
            ...
            $kd1=$C2kditem1;
            if (!empty($date1&&$date2)) {
            $hitung_count_A=mysqli_query($conn,"SELECT * FROM transaksi WHERE id_toko='$idtoko' AND tgltransaksi BETWEEN '$date1' AND '$date2' AND kditem='$kd1' ");
            } else {
            ...
            $kd2=$C2kditem2;
            if (!empty($date1&&$date2)) {
            $hitung_count_B=mysqli_query($conn,"SELECT * FROM transaksi WHERE id_toko='$idtoko' AND tgltransaksi BETWEEN '$date1' AND '$date2' AND kditem='$kd2' ");
            } else {
...
<tr style="background-color: lightgrey;text-align: center;">
    ...
    if (mysqli_num_rows($result)>0) {
		...
		<tr style="text-align: center;">
			...
			$kditem=$C2kditem1;
            if (!empty($date1&&$date2)) {
            $query_T=mysqli_query($conn,"SELECT * FROM transaksi WHERE id_toko='$idtoko' AND tgltransaksi BETWEEN '$date1' AND '$date2' AND kditem='$kditem' ");
            } else {
		...
		<tr style="text-align: center;">
		  ...
		  <td><?php
			...
			$kditem=$C2kditem2;
            if (!empty($date1&&$date2)) {
            $query_T2=mysqli_query($conn,"SELECT * FROM transaksi WHERE id_toko='$idtoko' AND tgltransaksi BETWEEN '$date1' AND '$date2' AND kditem='$kditem'");
            } else {
