...
ob_start();
include"../8_panel_penjualan/cart.php";
ob_end_clean();
unset($_SESSION[cart]);
...
<div id="bgproduct">
<div id="hightlight2"><center><i class="fa fa-tasks"></i> <H3>All Product List</H3> <br><a href="index.php?clear=y">>>All Shop List<<</a> <i class="fa fa-tasks"></i></center></div>

<?php
    while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
        {
    echo "<a href=\"detail.php?idtoko=".$row['id_toko']."&id=".$row['kditem']."&merk=".$row['merk']."\" class=\"tbeli\">";
        ...
        echo'</td></tr>';
          ...
          echo'<tr><td>';
          echo "<a href=\"detail.php?idtoko=".$row['id_toko']."&id=".$row['kditem']."&merk=".$row['merk']."\" class=\"tbeli\"><span>
