...
echo"<table id='desc_singkat'>";
    ...
    $qr=mysqli_fetch_array($getqr,MYSQLI_ASSOC);
	 ...
	 echo"</table>";	
echo'<table>';   
     echo"<td >".$gambar."<a href=\"../../gambar/toko/".$row['gambar_toko']."\" >
     <img src=\"../../gambar/toko/".$row['gambar_toko']."\" width='320px' height='320px' align=center border=1px </a>";	 
     echo"</td>";	
     echo"</tr>";    
echo"</table>";
...
echo"</table>";
echo"<br>";
echo "<a href=\"../8_panel_penjualan/index.php?&idtoko=".$row['id_toko']."\" class=\"tambah\"><span><input type='button' value='VISIT SHOP' class='btn4'></span></a>";
echo"</div>";
}
