    ...
    <div class="col-sm-6">
      <div class="panel-group">
        <div class="panel panel-default">
          ...
          <div class="panel-body"><a href="./android/8_panel_penjualan/index.php?idtoko='.$data['id_toko'].'"><iframe src="./dashboard_edit/halo_admin.php" width="100%" height="750"></iframe></a></div>
        </div>
      </div>
    </div>
